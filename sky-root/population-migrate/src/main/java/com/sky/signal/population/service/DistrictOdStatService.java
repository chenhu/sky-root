...
public class DistrictOdStatService implements ComputeService, Serializable {
    ...
    public void compute() {
        ...
        DataFrame table1 = odClassicDf.groupBy("date",
         ...
         FileUtil.saveFile(table1.repartition(1), FileUtil.FileType.CSV,params.getPopulationStatPath(params.getDistrictCode().toString()).concat("table1"));
        //统计对外出行OD2(含出行人数)
        ...
        FileUtil.saveFile(table2.repartition(1), FileUtil.FileType.CSV,params.getPopulationStatPath(params.getDistrictCode().toString()).concat("table2"));
        //统计 对外出行率统计表
        //1. 统计地市出发地
        ...
        FileUtil.saveFile(table4.repartition(1), FileUtil.FileType.CSV,params.getPopulationStatPath(params.getDistrictCode().toString()).concat("table4"));
    }
