...
public class CellSchemaProvider {
    ...
    public static final StructType CELL_SCHEMA_FULL = DataTypes.createStructType(Lists.newArrayList(
            DataTypes.createStructField("city_code", DataTypes.IntegerType, false),
            DataTypes.createStructField("district", DataTypes.StringType, false),
            DataTypes.createStructField("townId", DataTypes.StringType, false),
            DataTypes.createStructField("tac", DataTypes.IntegerType, false),
            DataTypes.createStructField("cell", DataTypes.LongType, false),
            DataTypes.createStructField("lng", DataTypes.DoubleType, false),
            DataTypes.createStructField("lat", DataTypes.DoubleType, false),
            DataTypes.createStructField("direction", DataTypes.IntegerType, false),
            DataTypes.createStructField("name", DataTypes.StringType, false),
            DataTypes.createStructField("geohash", DataTypes.StringType, false),
            DataTypes.createStructField("netId", DataTypes.StringType, false),
            DataTypes.createStructField("netType", DataTypes.StringType, false),
            DataTypes.createStructField("boundaryCellType", DataTypes.StringType, false)
    ));
    public static final StructType CELL_SCHEMA = DataTypes.createStructType(Lists.newArrayList(
            ...
            DataTypes.createStructField("name", DataTypes.StringType,
                    false),
            DataTypes.createStructField("geohash", DataTypes.StringType, false)));
    public static final StructType CELL_SCHEMA_NEW = DataTypes.createStructType(Lists.newArrayList(
            DataTypes.createStructField("city_code", DataTypes.IntegerType, false),
            DataTypes.createStructField("district", DataTypes.StringType, false),
            DataTypes.createStructField("townId", DataTypes.StringType, false),
            DataTypes.createStructField("tac", DataTypes.IntegerType, false),
