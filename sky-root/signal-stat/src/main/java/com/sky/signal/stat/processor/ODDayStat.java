...
public class ODDayStat implements Serializable{
    ...
    public DataFrame process(DataFrame ODDf) {
        DataFrame df = ODDf.groupBy("date", "leave_base", "arrive_base", "person_class", "trip_purpose")
                ...
                .orderBy("date","leave_base", "arrive_base", "person_class", "trip_purpose");
        FileUtil.saveFile(df.repartition(params.getStatpatitions()), FileUtil.FileType.CSV, params.getSavePath() + "stat/od-day-stat");
        return df;
